            ...
            <div className="bg-white dark:bg-dark-card p-4 shadow-sm dark:shadow-none">
                ...
                {favorites.length === 0 ? (
                    <div className="py-12 text-center">
                        <HeartFilled className="text-4xl text-gray-300 dark:text-gray-600 mb-3" />
                        <p className="text-gray-400 mb-2">Chưa có truyện yêu thích</p>
                        <p className="text-sm text-gray-500 mb-4">Nhấn nút ♡ trên trang truyện để thêm vào danh sách yêu thích</p>
